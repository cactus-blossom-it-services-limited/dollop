 ...
 *      "list_builder" = "Drupal\dollop\ProductListBuilder",
 *
 *     "form" = {
 *      "default" = "Drupal\dollop\Form\ProductForm",
 *      "add" = "Drupal\dollop\Form\ProductForm",
 *      "edit" = "Drupal\dollop\Form\ProductForm",
